...
function shuffle(array: number[]) {
    ...
    export const useGameStore = defineStore({
        ...
        getters: {
            ...
            cellColor: (state) => (x: number, y: number, isMain: boolean) => !state.generatedBoard[y][x] ? "lightgray" : (state.currentClickCell.x == x && state.currentClickCell.y == y && isMain) ? "#ddffdd" : "white",
        ...
        actions: {
            ...
            resetBoard() {
                ...
                const solvedBoard = this.solvedBoard;
